...
use App\Policies\ConstructionSiteLogPolicy;
use App\Policies\ConstructionSiteMaterialUsagePolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(ConstructionSiteMaterialUsage::class, ConstructionSiteMaterialUsagePolicy::class);
        Gate::policy(ConstructionSiteTimeEntry::class, ConstructionSiteTimeEntryPolicy::class);
        Gate::policy(Customer::class, CustomerPolicy::class);
        Gate::policy(CustomerContact::class, CustomerContactPolicy::class);
        Gate::policy(EmailAccount::class, EmailAccountPolicy::class);
        Gate::policy(EmailMessage::class, EmailMessagePolicy::class);
        Gate::policy(EmailMessageAttachment::class, EmailMessageAttachmentPolicy::class);
