...
class StorePurchaseDocumentRequest extends FormRequest
{
    protected function prepareForValidation(): void
    {
        ...
        foreach ($itemsInput as $line) {
            ...
            if (
                ($this->normalizeNullableInteger($line['purchase_order_item_id'] ?? null) === null)
                && $articleId === null
                && $description === null
                && $unitId === null
                && $quantity === null
            ...
            $normalizedItems[] = [
                'purchase_order_item_id' => $this->normalizeNullableInteger($line['purchase_order_item_id'] ?? null),
        ...
        $this->merge([
            ...
            'purchase_order_id' => $this->normalizeNullableInteger($this->input('purchase_order_id')),
