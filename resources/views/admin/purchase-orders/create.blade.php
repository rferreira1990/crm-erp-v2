...
@section('title', 'Nova encomenda a fornecedor')
@section('page_title', 'Nova encomenda a fornecedor')
@section('page_subtitle', 'Criacao manual de encomenda')
...
@section('breadcrumbs')
    <ol class="breadcrumb mb-0">
        ...
        <li class="breadcrumb-item active" aria-current="page">Nova encomenda</li>
    </ol>
@endsection
...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.purchase-orders.store') }}" id="manualPurchaseOrderForm">
        @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-4 col-lg-3">
                        ...
                        <input
                            ...
                            id="issue_date"
                            name="issue_date"
                            value="{{ old('issue_date', $defaults['issue_date']) }}"
        ...
        <div class="d-flex gap-2 justify-content-end">
            <a href="{{ route('admin.purchase-orders.index') }}" class="btn btn-phoenix-secondary">Cancelar</a>
