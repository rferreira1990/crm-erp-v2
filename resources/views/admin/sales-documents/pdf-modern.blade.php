...
<head>
    ...
    <style>
        ...
        .header { background: #0f172a; color: #ffffff; padding: 12px 14px; margin-bottom: 14px; border-radius: 8px; }
        ...
        .doc-meta { font-size: 10px; color: #cbd5e1; }
        ...
        .lines th { background: #dbeafe; font-size: 10px; text-transform: uppercase; }
        ...
        .totals .final td { background: #dbeafe; font-weight: bold; font-size: 12px; }
