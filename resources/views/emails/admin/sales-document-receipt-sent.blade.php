                ...
                <table role="presentation" width="640" cellspacing="0" cellpadding="0" border="0" style="width:100%;max-width:640px;background-color:#ffffff;border:1px solid #e5e7eb;border-radius:10px;overflow:hidden;">
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    ...
                                    <td align="right" style="vertical-align:middle;">
                                        ...
                                        <div style="margin-top:3px;font-size:20px;line-height:1.2;font-weight:700;color:#111827;">Recibo</div>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding:28px;">
                            <p style="margin:0 0 16px;font-size:15px;line-height:1.6;color:#111827;">Exmos. Senhores {{ $customerName }},</p>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin:16px 0 20px;border:1px solid #e5e7eb;border-radius:8px;">
                                <tr>
                                    <td style="padding:14px 16px;">
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            <tr>
                                                <td style="padding:4px 0;font-size:13px;color:#6b7280;width:220px;">Recibo</td>
                                                <td style="padding:4px 0;font-size:14px;color:#111827;font-weight:700;">{{ $summary['receipt_number'] }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding:4px 0;font-size:13px;color:#6b7280;">Data</td>
                                                <td style="padding:4px 0;font-size:14px;color:#111827;">{{ $summary['receipt_date'] }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding:4px 0;font-size:13px;color:#6b7280;">Documento de Venda</td>
                                                <td style="padding:4px 0;font-size:14px;color:#111827;">{{ $summary['sales_document_number'] ?? '-' }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding:4px 0;font-size:13px;color:#6b7280;">Modo de pagamento</td>
                                                <td style="padding:4px 0;font-size:14px;color:#111827;">{{ $summary['payment_method'] ?? '-' }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding:4px 0;font-size:13px;color:#6b7280;">Valor</td>
                                                <td style="padding:4px 0;font-size:14px;color:#111827;font-weight:700;">{{ $summary['amount'] }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <p style="margin:0;font-size:15px;line-height:1.6;color:#111827;">
                                Qualquer esclarecimento, estamos ao dispor.<br />
