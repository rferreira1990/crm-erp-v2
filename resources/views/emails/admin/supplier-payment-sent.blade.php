@php
    $supplierName = $payment->supplier?->name ?: 'Fornecedor';
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    ...
                                    <td align="right" style="vertical-align:middle;">
                                        ...
                                        <div style="margin-top:3px;font-size:20px;line-height:1.2;font-weight:700;color:#111827;">Pagamento a Fornecedor</div>
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin:16px 0 20px;border:1px solid #e5e7eb;border-radius:8px;">
                                <tr>
                                    <td style="padding:14px 16px;">
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            <tr>
                                                <td style="padding:4px 0;font-size:13px;color:#6b7280;width:220px;">Pagamento</td>
                                                <td style="padding:4px 0;font-size:14px;color:#111827;font-weight:700;">{{ $summary['payment_number'] }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding:4px 0;font-size:13px;color:#6b7280;">Data</td>
                                                <td style="padding:4px 0;font-size:14px;color:#111827;">{{ $summary['payment_date'] }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding:4px 0;font-size:13px;color:#6b7280;">Documento de Compra</td>
                                                <td style="padding:4px 0;font-size:14px;color:#111827;">{{ $summary['purchase_document_number'] ?? '-' }}</td>
                                            </tr>
                                            <tr>
