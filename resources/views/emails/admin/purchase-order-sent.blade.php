@php
    $supplierName = $purchaseOrder->supplier_name_snapshot ?: 'Fornecedor';
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    ...
                                    <td align="right" style="vertical-align:middle;">
                                        ...
                                        <div style="margin-top:3px;font-size:20px;line-height:1.2;font-weight:700;color:#111827;">Encomenda a Fornecedor</div>
                                    </td>
                                </tr>
                            </table>
                        </td>
                                ...
                                <tr>
                                    <td style="padding:14px 16px;">
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                            ...
                                            <tr>
                                                <td style="padding:4px 0;font-size:13px;color:#6b7280;">Referencia RFQ</td>
                                                <td style="padding:4px 0;font-size:14px;color:#111827;">{{ $summary['rfq_number'] ?? '-' }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding:4px 0;font-size:13px;color:#6b7280;">N. documento fornecedor</td>
                                                <td style="padding:4px 0;font-size:14px;color:#111827;">{{ $summary['supplier_document_number'] ?? '-' }}</td>
                                            </tr>
                                            <tr>
